...
test("breadth-first returns correct order (1)", () => {
  const clone = Object.assign(Object.create(Object.getPrototypeOf(A)), A);
  expect(breadthFirstSearch(clone)).toStrictEqual(expected);
});

test("breadth-first returns correct order (2)", () => {
  const clone = Object.assign(Object.create(Object.getPrototypeOf(A)), A);
  expect(breadthFirstSearch(clone)).toStrictEqual(expected);
});

test("breadth-first returns correct order (3)", () => {
  const clone = Object.assign(Object.create(Object.getPrototypeOf(A)), A);
  expect(breadthFirstSearch(clone)).toStrictEqual(expected);
});

test("breadth-first returns correct order (4)", () => {
  const clone = Object.assign(Object.create(Object.getPrototypeOf(A)), A);
  expect(breadthFirstSearch(clone)).toStrictEqual(expected);
});
